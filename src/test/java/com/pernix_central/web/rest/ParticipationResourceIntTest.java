...
public class ParticipationResourceIntTest {
    ...
    public void initTest() {
        ...
        participation.setDescription(DEFAULT_DESCRIPTION);
    }
    ...
    public void createParticipation() throws Exception {
        ...
        assertThat(testParticipation.getDescription()).isEqualTo(DEFAULT_DESCRIPTION);
    }
    ...
    public void updateParticipation() throws Exception {
        ...
        updatedParticipation.setDescription(UPDATED_DESCRIPTION);
        ...
        assertThat(testParticipation.getDescription()).isEqualTo(UPDATED_DESCRIPTION);
    }
